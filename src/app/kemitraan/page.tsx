  ...
  return (
    <>
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .btn-cta { background: #000; color: #fff; border: 1px solid #fff; padding: 16px 24px; border-radius: 8px; font-size: 16px; font-weight: 600; cursor: pointer; transition: 0.3s; text-align: center; width: 100%; max-width: 400px; font-family: inherit; }
        ...
        @media (max-width: 768px) {
          ...
          .cta-section { padding: 60px 0; min-height: 450px; }
      ...
      <main>
        ...
        <div className="hero-image-container">
          <img src="/asset/hero-kemitraan.png" className="hero-image" alt="Dashboard Minton" />
        </div>
          ...
          <div className="benefits-content">
            ...
            <div className="benefits-grid">
              <div className="benefit-item">
                <img src="/asset/icon-sistem-booking.png" />
                <h4>Sistem Booking 24/7</h4>
                <p>Fasilitas booking di Minton tersedia 24 jam. Tanpa perlu admin stand by, biarkan sistem bekerja mencatat pesanan untuk Anda.</p>
              </div>
              <div className="benefit-item">
                <img src="/asset/icon-verifikasi-pembayaran.png" />
                <h4>Verifikasi Pembayaran</h4>
                <p>Tidak perlu lagi cek mutasi rekening harian. Sistem Minton otomatis memverifikasi pembayaran dari pelanggan secara real-time.</p>
              </div>
              <div className="benefit-item">
                <img src="/asset/icon-jangkauan-pemain.png" />
                <h4>Jangkauan Pasar Luas</h4>
                <p>Jadikan GOR Anda mudah ditemukan oleh ribuan pegiat olahraga di ekosistem digital Minton dan sekitarnya.</p>
              </div>
              <div className="benefit-item">
                <img src="/asset/icon-analisis-pendapatan.png" />
                <h4>Analisis Pendapatan</h4>
                <p>Pantau laporan keuangan dan jam paling ramai di GOR Anda melalui Dashboard Mitra yang intuitif.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="features-section">
          ...
          <div className="features-grid">
            <div className="feature-item reveal">
              <img src="/asset/icon-real-time.png" />
              <div className="feature-content">
                <h4>Real-Time Availability</h4>
                <p>Kelola ketersediaan lapangan secara instan. Hindari double-booking yang merugikan operasional harian Anda.</p>
              </div>
            </div>
            <div className="feature-item reveal">
              <img src="/asset/icon-manajemen-member.png" />
              <div className="feature-content">
                <h4>Manajemen Member</h4>
                <p>Atur jadwal member tetap GOR Anda dengan mudah, cukup atur sekali di awal dan sistem akan menyesuaikan.</p>
              </div>
            </div>
            <div className="feature-item reveal">
              <img src="/asset/icon-e-invoicing.png" />
              <div className="feature-content">
                <h4>E-Invoicing</h4>
          ...
          <div className="cta-container">
            <div className="cta-content">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginTop: '32px' }}>
                <a href="/kemitraan/registrasi" className="btn-cta" style={{ textDecoration: 'none' }}>Daftarkan GOR Sekarang!</a>
                <a href="/kemitraan/login-mitra" className="btn-cta btn-cta-login" style={{ flex: 1, textDecoration: 'none' }}>Login Dashboard</a>
              </div>
            </div>
          </div>
        </section>
